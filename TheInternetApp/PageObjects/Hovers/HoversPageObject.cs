...
public class HoversPageObject : BasePageObject
{
    ...
    public IReadOnlyCollection<IWebElement> UserImages => WebDriver.FindElements(_userImagesLocator);

    public IReadOnlyCollection<IWebElement> UserViewsLinks => WebDriver.FindElements(_userViewLinksLocator);
    

    public IReadOnlyCollection<IWebElement> UserNameHeaders => WebDriver.FindElements(_userNameHeadersLocator);
